"""DAG DLP_MART: ежечасный запуск сохранённого SQL-запроса DataLens Platform.

Раз в час (cron "0 * * * *") выполняет сохранённый SQL-запрос DLP
...
with DAG(
    dag_id="DLP_MART",
    description="Раз в час выполняет сохранённый SQL-запрос DLP (витрина, preprod) через dlp_sdk",
